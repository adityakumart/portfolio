...
const badgeVariants = cva(
	'inline-flex items-center justify-center w-fit shrink-0 whitespace-nowrap rounded-full border border-transparent font-medium transition-colors select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 group/badge [&>ng-icon]:pointer-events-none [&>ng-icon]:size-3.5 has-data-[icon=inline-end]:pe-1.5 has-data-[icon=inline-start]:ps-1.5',
	{
		variants: {
			variant: {
				default:
