...
export class ExperienceService {
  ...
  private experienceDbService = new IndexedDbService<UserExperienceRecord>('PortfolioDatabase', this.storeName, 1);
  ...
  async addExperience(experience: Omit<UserExperienceRecord, 'id'>): Promise<void> {
