...
import { JsonTypeInfo, TransformResult } from '../models/json-transformer.interface';
    ...
    try {
      ...
      if (Array.isArray(parsedJson)) {
        return {
          success: false,
          interface: '',
          error: 'JSON input must be an object, not an array. Try wrapping it in an object.'
        };
      }
