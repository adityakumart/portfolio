                ...
                projects: [
                    {
                        ...
                        skills: [
                            "React JS", "Material UI", "SCSS", "TypeScript", "Chrome Extensions API", "Node.js", "MongoDB", "Vite", "Zustand"
                        ]
                    },
                    {
                        ...
                        description: "Designed and implemented the complete user interface of both Sequence (automated outreach) and Workflow (ATS software) modules within a highly performant Single Page Application (SPA) architecture. Developed complex dynamic form elements using Formik and YUP schema builder.",
                        link: "",
                        skills: [
                            "React JS", "Material UI", "SCSS", "TypeScript", "Formik", "Yup"
                        ]
                    },
                    {
                        name: "Accuick",
                        ...
                        description: "Architected and developed the UI from scratch for staffing VMS/MSP clients. Engineered robust, data-intensive forms using Angular Reactive Forms and FormArrays. Leveraged RxJS observables for sophisticated asynchronous data handling.",
                        link: "",
                        skills: [
                            "Angular 13", "Material UI", "SCSS", "TypeScript", "RxJS"
                        ]
                    },
                ]
            },
                ...
                projects: [
                    {
                        ...
                        position: "Web Developer",
                        description: "Developed a scalable, high-availability web application front-end for a nationwide customer service talent platform. Engineered dynamic PDF file generation directly from the browser and integrated Oneall API for social login.",
                        link: "https://www.cxninja.com/",
                        skills: [
                            "Angular 12", "Angular Material", "SCSS", "TypeScript"
                        ]
                    },
                    {
                        name: "ACCUICK",
                        ...
                        position: "Web Developer",
                        description: "Designed and developed highly responsive, interactive web pages utilizing the Bootstrap CSS framework and custom CSS Media Queries. Integrated multiple HTML themes and deeply customized various jQuery Plugins.",
                        link: "",
                        skills: [
                            "Bootstrap", "jQuery", "HTML5", "CSS3", "JSON"
                        ]
                    },
                    {
                        name: "Onboarding",
                        ...
                        description: "Contributed significantly to the frontend development of an advanced, versatile paperless onboarding tool tailored specifically for the unique needs of the staffing industry.",
                        link: "https://www.ova.work/",
                        skills: [
                            "AngularJS", "REST API", "HTML5", "CSS3"
                        ]
                    },
                ]
            }
        ...
        awards: [
            {
                ...
                summary: "Honored for outstanding technical performance and timely project delivery under pressure."
            },
            {
                title: "Applause Award",
                date: "2018-08",
                awarder: "OVA Innovation Labs",
                summary: "Received for exceptional contributions and dedication to the frontend development team."
            }
        ],
        certificates: [
            {
        ...
        skills: [
            ...
            },
            {
                ...
                keywords: [
                    ...
                    { name: "Chrome Extensions API", url: "https://developer.chrome.com/docs/extensions/reference/" }
                ]
            }
        ],
        languages: [{
